...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1297: x0 => x0.send(),
      _1298: () => new XMLHttpRequest(),
      _1299: Date.now,
      _1301: s => new Date(s * 1000).getTimezoneOffset() * 60,
      _1302: s => {
      ...
      _1304: () => typeof dartUseDateNowForTicks !== "undefined",
      _1305: () => 1000 * performance.now(),
      _1306: () => Date.now(),
      _1307: () => {
      ...
      _1309: () => new WeakMap(),
      _1310: (map, o) => map.get(o),
      _1311: (map, o, v) => map.set(o, v),
      _1312: x0 => new WeakRef(x0),
      _1313: x0 => x0.deref(),
      _1320: () => globalThis.WeakRef,
      _1324: s => JSON.stringify(s),
      _1325: s => printToConsole(s),
      _1326: (o, p, r) => o.replaceAll(p, () => r),
      _1328: Function.prototype.call.bind(String.prototype.toLowerCase),
      _1329: s => s.toUpperCase(),
      _1330: s => s.trim(),
      _1331: s => s.trimLeft(),
      _1332: s => s.trimRight(),
      _1333: (string, times) => string.repeat(times),
      _1334: Function.prototype.call.bind(String.prototype.indexOf),
      _1335: (s, p, i) => s.lastIndexOf(p, i),
      _1336: (string, token) => string.split(token),
      _1337: Object.is,
      _1338: o => o instanceof Array,
      _1339: (a, i) => a.push(i),
      _1343: a => a.pop(),
      ...
      _1357: o => o instanceof Uint8Array,
      _1358: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1359: o => o instanceof Int8Array,
      _1360: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1361: o => o instanceof Uint8ClampedArray,
      _1362: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1363: o => o instanceof Uint16Array,
      _1364: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1365: o => o instanceof Int16Array,
      _1366: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1367: o => o instanceof Uint32Array,
      _1368: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1369: o => o instanceof Int32Array,
      ...
      _1373: o => o instanceof Float32Array,
      _1374: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1375: o => o instanceof Float64Array,
      _1376: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1377: (t, s) => t.set(s),
      _1379: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1380: o => o.byteLength,
      _1381: o => o.buffer,
      _1382: o => o.byteOffset,
      _1383: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1384: (b, o) => new DataView(b, o),
      _1385: (b, o, l) => new DataView(b, o, l),
      _1386: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1387: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1388: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1389: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1390: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1391: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1392: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1393: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1394: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1395: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1396: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1397: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1400: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1401: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1402: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1403: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1404: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1405: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1418: (ms, c) =>
      setTimeout(() => dartInstance.exports.$invokeCallback(c),ms),
      _1419: (handle) => clearTimeout(handle),
      _1420: (ms, c) =>
      setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
      _1421: (handle) => clearInterval(handle),
      _1422: (c) =>
      queueMicrotask(() => dartInstance.exports.$invokeCallback(c)),
      _1423: () => Date.now(),
      _1428: o => Object.keys(o),
      _1432: () => new XMLHttpRequest(),
      _1433: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1434: x0 => x0.send(),
      _1436: () => new FileReader(),
      _1437: (x0,x1) => x0.readAsArrayBuffer(x1),
      ...
      _1566: x0 => x0.style,
      _1569: x0 => x0.src,
      _1570: (x0,x1) => { x0.src = x1 },
      _1571: x0 => x0.naturalWidth,
      _1572: x0 => x0.naturalHeight,
      _1588: x0 => x0.status,
      _1589: (x0,x1) => { x0.responseType = x1 },
      _1591: x0 => x0.response,
      _1640: (x0,x1) => { x0.responseType = x1 },
      _1641: x0 => x0.response,
      _1730: (x0,x1) => { x0.oncancel = x1 },
      _1736: (x0,x1) => { x0.onchange = x1 },
      _1776: (x0,x1) => { x0.onerror = x1 },
      ...
      _5989: x0 => x0.target,
      _6029: x0 => x0.signal,
      _6101: () => globalThis.document,
      _6183: x0 => x0.body,
      _6517: (x0,x1) => { x0.id = x1 },
      _7863: x0 => x0.value,
      _7865: x0 => x0.done,
      _8045: x0 => x0.size,
      _8046: x0 => x0.type,
      _8053: x0 => x0.name,
      _8054: x0 => x0.lastModified,
      _8059: x0 => x0.length,
      _8065: x0 => x0.result,
      _8562: x0 => x0.url,
      _8564: x0 => x0.status,
