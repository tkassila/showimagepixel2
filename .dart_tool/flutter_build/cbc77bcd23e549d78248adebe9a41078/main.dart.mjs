...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1347: (x0,x1) => x0.querySelector(x1),
      ...
      _1352: x0 => x0.click(),
      _1353: x0 => x0.decode(),
      _1354: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1355: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      ...
      _1558: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      _1559: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      _1570: () => new FileReader(),
      _1571: (x0,x1) => x0.readAsArrayBuffer(x1),
      ...
      _1698: (x0,x1) => { x0.responseType = x1 },
      _1699: x0 => x0.response,
      _1788: (x0,x1) => { x0.oncancel = x1 },
      _1794: (x0,x1) => { x0.onchange = x1 },
      _1834: (x0,x1) => { x0.onerror = x1 },
      _2704: (x0,x1) => { x0.accept = x1 },
      _2718: x0 => x0.files,
      _2744: (x0,x1) => { x0.multiple = x1 },
      _2762: (x0,x1) => { x0.type = x1 },
      _3480: () => globalThis.window,
      _3543: x0 => x0.navigator,
      _3933: x0 => x0.vendor,
      _6046: x0 => x0.type,
      _6047: x0 => x0.target,
      _6087: x0 => x0.signal,
